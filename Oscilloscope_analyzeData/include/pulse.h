...
// Tue May 16 21:46:20 2017 by ROOT version 6.00/02
// from TTree pulse/Digitized waveforms
// found on file: Run657_RECO.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Run657_RECO.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Run657_RECO.root");
      }
...
void pulse::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("int", intint, &b_int);
